  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        '*': { scrollbarWidth: 'thin', scrollbarColor: `${palette.rule2} transparent` },
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedPrimary: { backgroundColor: palette.ink, '&:hover': { backgroundColor: '#0F1722' } },
        outlinedPrimary: {
          borderColor: palette.rule2, color: palette.ink,
    ...
    MuiPaper: {
      ...
      styleOverrides: {
        root: { backgroundImage: 'none', backgroundColor: palette.surface },
    ...
    MuiChip: {
      styleOverrides: {
        root: { fontWeight: 500, fontSize: '0.75rem', borderRadius: 3, height: 24, letterSpacing: '0.01em' },
    ...
    MuiTableCell: {
      styleOverrides: {
        ...
        head: {
          backgroundColor: palette.surface2, fontWeight: 600, color: palette.ink2,
    ...
    MuiLink: {
      ...
      styleOverrides: {
        root: {
          color: palette.ink, textDecorationColor: palette.rule2, textUnderlineOffset: '3px',
    ...
    MuiToggleButton: {
      styleOverrides: {
        root: {
          textTransform: 'none', borderColor: palette.rule2, color: palette.ink2,
          fontSize: '0.8125rem', paddingInline: 12,
          '&.Mui-selected': {
            backgroundColor: palette.ink, color: palette.surface,
